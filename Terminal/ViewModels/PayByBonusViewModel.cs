...
// Type: Terminal.ViewModels.PayByBonusViewModel
...
{
  public class PayByBonusViewModel : ViewModelBase
  {
    ...
    public ICommand AddDigitCommand => (ICommand) new Command(new Action<object>(this.AddDigitCick), true);
    ...
    public PinResponse PinResponse { get; set; }
    ...
    private void AddDigitCick(object param)
    {
