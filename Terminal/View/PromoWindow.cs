...
// Type: Terminal.View.PromoWindow
...
{
  public class PromoWindow : Window, IComponentConnector
  {
    internal Grid MainGrid;
    private bool _contentLoaded;

    public PromoWindow() => this.InitializeComponent();
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/Terminal;component/view/promowindow.xaml", UriKind.Relative));
    }
